...
import net.mcreator.cravingsmod.item.ToastedSunflowerSeedsItem;
import net.mcreator.cravingsmod.item.ToastItem;
import net.mcreator.cravingsmod.item.SunflowerSeedsItem;
...
import net.mcreator.cravingsmod.item.PricklyPearItem;
...
import net.mcreator.cravingsmod.item.JalapenoSeedsItem;
import net.mcreator.cravingsmod.item.JalapenoItem;
...
import net.mcreator.cravingsmod.item.GreenPepperSeedsItem;
import net.mcreator.cravingsmod.item.GreenPepperItem;
...
import net.mcreator.cravingsmod.item.ButterItem;
...
public class CravingsModModItems {
	...
	public static final DeferredItem<Item> TOASTED_SUNFLOWER_SEEDS = register("toasted_sunflower_seeds", ToastedSunflowerSeedsItem::new);
	public static final DeferredItem<Item> PRICKLY_PEAR = register("prickly_pear", PricklyPearItem::new);
	public static final DeferredItem<Item> JALAPENO = register("jalapeno", JalapenoItem::new);
