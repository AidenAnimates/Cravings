...
public class BeerBottleItem extends Item {
	public BeerBottleItem() {
		super(new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON).food((new FoodProperties.Builder()).nutrition(3).saturationModifier(0.5f).alwaysEdible().build()));
	}
